...
- Vercel Cronで、5分前通知、呼出失効、終了3分前確認、終了予定5分後の自動完了を実装する。
...
- migration、seed、環境変数、Vercel Cron、OneSignal、Turnstile、利用規約・プライバシーポリシーについて、運営者が設定・確認できる引き継ぎ手順が揃っているか。
...
| Vercelプロジェクト・本番ドメイン | Preview / 本番配信、Cron | 運営者 |
